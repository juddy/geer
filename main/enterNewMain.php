...
<input type="submit" name="submitEnterMainForm" value="Submit New Record" class="nice radius large blue button">
<input type="submit" name="resetForm" value="Clear Form" class="nice radius large blue button">
</form>
