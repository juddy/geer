...
?>
    ...
    <TD><a href="provisionMain.php?Clql_HostnameField=<? echo $thisClql_Hostname; ?>"=<? echo $thisClql_Hostname; ?>"><img src="../common/provision-button.png"</a></TD>
