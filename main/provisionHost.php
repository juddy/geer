...
<h1>Provision a Host with Rsyphon</h1>
<form name="mainProvisionForm" method="POST" action="provisionMain.php">
    ...
    <input class="small purple nice button" type="submit" name="submitProvisionMainForm" value="Provision Host">
