...
?>
<?
$thisDC_HostnameFromForm = $_REQUEST['thisDC_HostnameField'];
$thisPublic_IPFromForm = $_REQUEST['thisPublic_IPField'];
...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE main SET Datacenter = '$thisDatacenter' , DC_Hostname = '$thisDC_Hostname' , Clql_Hostname = '$thisClql_Hostname' , Domain_Name = '$thisDomain_Name' , CNAME = '$thisCNAME' , Public_IP = '$thisPublic_IP' , Network = '$thisNetwork' , DMZ_IP = '$thisDMZ_IP' , Mgmt_IP = '$thisMgmt_IP' , Public_MAC = '$thisPublic_MAC' , DMZ_MAC = '$thisDMZ_MAC' , MGMT_MAC = '$thisMGMT_MAC' , Description = '$thisDescription' , ServiceTag = '$thisServiceTag' , Row = '$thisRow' , Rack = '$thisRack' , Slot = '$thisSlot'  WHERE DC_Hostname = '$thisDC_Hostname'";
	$resultUpdate = MYSQL_QUERY($sqlUpdate);
	echo "<b>Record with Id ".$thisDC_HostnameFromForm." has been Updated<br></b>";
	$thisDC_HostnameFromForm = "";
}
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO main (Datacenter , DC_Hostname , Clql_Hostname , Domain_Name , CNAME , Public_IP , Network , DMZ_IP , Mgmt_IP , Public_MAC , DMZ_MAC , MGMT_MAC , Description , ServiceTag , Row , Rack , Slot ) VALUES ('$thisDatacenter' , '$thisDC_Hostname' , '$thisClql_Hostname' , '$thisDomain_Name' , '$thisCNAME' , '$thisPublic_IP' , '$thisNetwork' , '$thisDMZ_IP' , '$thisMgmt_IP' , '$thisPublic_MAC' , '$thisDMZ_MAC' , '$thisMGMT_MAC' , '$thisDescription' , '$thisServiceTag' , '$thisRow' , '$thisRack' , '$thisSlot' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM main WHERE DC_Hostname = '$thisDC_Hostname'";
	$resultDelete = MYSQL_QUERY($sqlDelete);

	echo "<b>Record with Id ".$thisDC_HostnameFromForm." has been Deleted<br></b>";
	$thisDC_HostnameFromForm = "";
}
...
<TABLE CELLSPACING="0" CELLPADDING="3" BORDER="0" WIDTH="100%">
	<TR>
		...
		<TD>
			<a href="<? echo $PHP_SELF; ?>?sortBy=Clql_Hostname&sortOrder=<? echo $newSortOrder; ?>&startLimit=<? echo $startLimit; ?>&rows=<? echo $limitPerPage; ?>">
				<B>Clql_Hostname</B>
			</a>
</TD>
		<TD>
...
<input type="hidden" name="thisDC_HostnameField" value="<? echo $thisDC_Hostname; ?>">
	<TR BGCOLOR="#FF6666">
		<TD><input type"text" name="thisDatacenterField" value=""></TD>
		<TD><input type"text" name="thisDC_HostnameField" value=""></TD>
		<TD><input type"text" name="thisClql_HostnameField" value=""></TD>
...
if ($thisDC_HostnameFromForm == $thisDC_Hostname)
{
...
<input type="hidden" name="thisDC_HostnameField" value="<? echo $thisDC_Hostname; ?>">
	<TR BGCOLOR="<? echo $bgColor; ?>">
		<TD width="10"><input type"text" name="thisDatacenterField" value="<? echo $thisDatacenter; ?>"></TD>
		<TD width="50"><input type"text" name="thisDC_HostnameField" value="<? echo $thisDC_Hostname; ?>"></TD>
		<TD><input type"text" name="thisClql_HostnameField" value="<? echo $thisClql_Hostname; ?>"></TD>
...
?>
	<TR BGCOLOR="<? echo $bgColor; ?>">
		<TD width="10"><? echo $thisDatacenter; ?></TD>
		<TD width="50"><? echo $thisDC_Hostname; ?></TD>
		...
		<TD><? echo $thisRack; ?></TD>
		<TD><? echo $thisSlot; ?></TD>
	<TD><a href="<? echo $_SERVER['PHP_SELF']; ?>?action=Edit&thisDC_HostnameField=<? echo $thisDC_Hostname; ?>">Edit</a></TD>
	<TD><a href="<? echo $_SERVER['PHP_SELF']; ?>?action=Delete&thisDC_HostnameField=<? echo $thisDC_Hostname; ?>">Delete</a></TD>
	</TR>
